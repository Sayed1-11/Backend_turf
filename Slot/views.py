...
class TurfSlotViewSet(viewsets.ModelViewSet):
    ...
    def apply_coupon(self, request, pk=None):
        ...
        # Attach the coupon to the slot instance and calculate the discounted price
        slot_instance.coupon = coupon
        total_price = slot_instance.calculate_price()
        
        # Save the slot instance with the applied coupon
        slot_instance.save()
        
        return Response({
            'message': 'Coupon applied successfully!',
            'total_price': total_price,
            'discount': coupon.discount_amount if coupon.discount_amount else 0,

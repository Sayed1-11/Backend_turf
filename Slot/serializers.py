...
class TurfSlotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = TurfSlot
        fields = ['id', 'user', 'turf', 'field', 'start_time', 'end_time', 'date', 'discounted_price',
...
class SwimmingSlotSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = SwimmingSlot
        fields = ['id', 'user', 'turf', 'field', 'date', 'is_booked', 'session','discounted_price', 'number_of_people','calculated_price']

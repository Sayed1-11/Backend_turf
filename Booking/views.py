...
class TurfBookingViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        pay = aamarPay(
            ...
            successUrl='http://127.0.0.1:8000/payment/success/',  # Replace with actual success URL
            failUrl='http://127.0.0.1:8000/payment/failure/',  # Replace with actual failure URL
            cancelUrl='http://yourdomain.com/cancel',  # Replace with actual cancel URL
...
class SwimmingBookingViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        pay = aamarPay(
            ...
            successUrl='http://127.0.0.1:8000/payment/success/',  # Replace with actual success URL
            failUrl='http://127.0.0.1:8000/payment/failure/',  # Replace with actual failure URL
            cancelUrl='http://127.0.0.1:8000/payment/callback/',
            transactionID=transaction_id,  # Unique transaction ID
            transactionAmount=str(booking.advance_payable),  # Convert to string if required
            signature=settings.AAMARPAY_SIGNATURE_KEY,  # Your actual signature
